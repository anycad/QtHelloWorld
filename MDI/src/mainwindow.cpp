...
{
   {
      ...
      dockingList = new QTreeWidget(dock);
   ...
   }
   {
      ...
      QListWidget* mdockingList = new QListWidget(dock);
      mdockingList->addItems(QStringList()
         << "1"
         << "2"
         << "3"
         << "4"
      ...
      toolBox->addItem(mdockingList, "Test");
      toolBox->addItem(new QPushButton("B"), "Test2");
      toolBox->addItem(new QPushButton("C"), "Test3");
